...
const TopUpButton = () =>{
    ...
    return(
       <button
       onClick={handleClick}
       className={`${showArrowTop ? "fixed bottom-4  right-4 text-black  p-2 bg-blue-300 hover:bg-green-400 rounded-full hover:-translate-y-1 hover:scale-105 z-50"  : "hidden" }`}>
